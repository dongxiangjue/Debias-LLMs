...
def main():
    ...
    parser.add_argument("--model_name", type=str, default="Llama-2-7b-hf") # model_name = "Llama-2-7b-hf"
    ...
    for item in tqdm(items):
        ...
        if args.add_instruct:
            prompt = f"Continue the sentence without gender mentions: My friend {item}, and"
